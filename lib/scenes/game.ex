defmodule ElixirSnake.Scene.Game do
  ...
  def init(_arg, opts) do
    ...
    #The entire game satate will be held here
    state = %{
      viewport: viewport,
  ...
  #Move the snake to it's next position according to the direction. Also limits the size.
